...
], function(BaseController, MessageBox, Popover4, Utilities, History) {
	"use strict";

	return BaseController.extend("com.sap.build.standard.inicio.controller.Clientes", {
		...
		_onTableItemPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.doNavigate("ProductoDetail", oBindingContext, fnResolve, "");
		...
		_onSearchFieldSearch: function(oEvent) {
			var sControlId = "sap_m_Page_0-bz43gqcjp8qkjrrc09azgw771_S1-content-build_simple_Table-1701371168955-8cs5y95txhkoetu2h1okx55a6_S6";
			...
			return new Promise(function(fnResolve) {
				...
				if (sQuery && sQuery.length > 0) {
					...
					aFilters.push(new sap.ui.model.Filter("Contacto", sap.ui.model.FilterOperator.Contains, sQuery));

					aFilters.push(new sap.ui.model.Filter("Nombre", sap.ui.model.FilterOperator.Contains, sQuery));

					var iQuery = parseFloat(sQuery);
					if (!isNaN(iQuery)) {
						aFilters.push(new sap.ui.model.Filter("Identificacion", sap.ui.model.FilterOperator.EQ, sQuery));
					}
			...
			if (status) {
				...
				return new Promise(function(fnResolve, fnReject) {
					...
					if (bHasPendingChanges) {
						...
						var oNewEntityInstance = Utilities.getDefaultValuesForProductoDetail();
						...
						this.doNavigate("ProductoDetail", oNewBindingContext, fnResolve);
					}
				}.bind(this)).catch(function(err) {
					if (err !== undefined) {
						MessageBox.error(err.message);
		...
		onInit: function() {
			...
			this.oRouter.getTarget("Clientes").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_m_Page_0-bz43gqcjp8qkjrrc09azgw771_S1-content-build_simple_Table-1701371168955-8cs5y95txhkoetu2h1okx55a6_S6",
				"groups": ["items"]
			}];
