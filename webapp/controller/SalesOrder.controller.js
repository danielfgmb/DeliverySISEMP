sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.inicio.controller.SalesOrder", {
		...
		_onTableItemPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.doNavigate("SalesOrderDetail", oBindingContext, fnResolve, "");
			...
			if (status) {
				...
				return new Promise(function(fnResolve, fnReject) {
					...
					if (bHasPendingChanges) {
						...
						var oNewEntityInstance = Utilities.getDefaultValuesForSalesOrderCreate();

						oModel = this.getView().getModel();
						var oNewBindingContext = oModel.createEntry("SalesOrderSet", {
							properties: oNewEntityInstance
						});

						this.doNavigate("SalesOrderCreate", oNewBindingContext, fnResolve);
					}
				}.bind(this)).catch(function(err) {
					if (err !== undefined) {
						MessageBox.error(err.message);
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_m_Page_0-bz43gqcjp8qkjrrc09azgw771_S1-content-build_simple_Table-1701371168955-ij2m0g76drcpi7o1mk14tdfg4_S4",
				"groups": ["items"]
			}];
